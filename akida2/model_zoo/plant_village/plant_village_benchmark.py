...
"""
PlantVillage hardware benchmark for Akida 2.

Runs a latency benchmark on an Akida PlantVillage model, prints a summary, checks
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Hardware latency benchmark for an Akida 2 PlantVillage model')
