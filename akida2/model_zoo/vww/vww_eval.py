...
if __name__ == '__main__':
    ...
    if args.save_metrics:
        ...
        #
        # The Akida 2 VWW example has two quantized variants, disambiguated by
        ...
        #   akidanet_vww_i8_w4_a4_qat.{h5,fbz} -> w4a4_qat_quant_acc / w4a4_qat_akida_acc
        ...
        # Determine the variant prefix from the filename.
        if 'i8_w8_a8' in stem:
            variant = 'w8a8'
