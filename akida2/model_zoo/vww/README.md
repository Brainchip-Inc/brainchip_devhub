...
model is quantized with **`quantizeml`** to 8-bit activations; 8-bit weights need
no quantization-aware training (QAT), while a lower-precision 4-bit-weight variant
is provided both with and without QAT.
...
| 4-bit quantization | `quantizeml quantize` to 4-bit weights, 8-bit activations — provided both PTQ-only and with QAT fine-tuning |
...
# 4-bit variant (PTQ)
python vww_eval.py -l pretrained_models/akidanet_vww_i8_w4_a8.h5 --save-metrics
python vww_eval.py -l pretrained_models/akidanet_vww_i8_w4_a8.fbz --save-metrics
python vww_benchmark.py -l pretrained_models/akidanet_vww_i8_w4_a8.fbz --save-metrics

# 4-bit variant (QAT)
python vww_eval.py -l pretrained_models/akidanet_vww_i8_w4_a8_qat.h5 --save-metrics
python vww_eval.py -l pretrained_models/akidanet_vww_i8_w4_a8_qat.fbz --save-metrics
python vww_benchmark.py -l pretrained_models/akidanet_vww_i8_w4_a8_qat.fbz --save-metrics
