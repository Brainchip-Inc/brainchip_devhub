...
"""
Detection per-layer hardware benchmark.

Runs a per-layer timing benchmark on an Akida detection model, prints a
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Per-layer hardware benchmark for an Akida detection model')
