...
"""
Software-only sparsity measurement for a VWW model (float .h5, quantized .h5,
or Akida .fbz). Does not require Akida hardware -- compute_sparsity runs
inference through the software backend.

Use this in place of vww_benchmark.py when no Akida device is connected;
it gives the accuracy/sparsity half of the trade-off, without hardware
latency/power numbers.

Example
-------
    python vww_sparsity_only.py -l models/akidanet_vww_qat.fbz
"""
import argparse
