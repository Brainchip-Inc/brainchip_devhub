...
"""
Arrhythmia classification per-layer hardware benchmark.

Runs a per-layer timing benchmark on the Akida arrhythmia model, prints a
summary table, and generates a summary plot.

Example
-------
    python arrhythmia_benchmark.py -l pretrained_models/arrhythmia_classification_qat.fbz
"""
import argparse
import json
import pathlib
...
from arrhythmia_data import get_samples
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Per-layer hardware benchmark for the Akida arrhythmia model')
