...
def build_dataset(dataset_path: str):
    ...
    builder = ECGDatasetBuilder(dataset_path=args.dataset_path, data_dir=args.data_dir, window_before=250, window_after=250, img_size=32)
...
def main():
    ...
    if args.load_splits:
        ...
        X_test, y_test = build_dataset(args.dataset_path)
        if args.save_splits:
            print("\nSaving splits ...")
