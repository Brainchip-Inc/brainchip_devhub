...
"""
Speech Commands evaluation for tf_keras or akida models.
Example
-------
    python speech_commands_eval.py -d ./data/sc10 -l speech_commands.h5
"""
import argparse
import json
import pathlib
...
if __name__ == '__main__':
    ...
    _, _, val_ds = get_datasets(
        data_dir=args.data, batch_size=100, data_transform=data_transform
    )
